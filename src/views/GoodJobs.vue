<template>
  <div>
    <div class="page-header"><h1 class="page-title"><span>👍</span> 好工作推荐</h1><button v-if="appStore.isLoggedIn" class="btn btn-success" @click="showForm = true">+ 发布推荐</button></div>
    ...
    <div v-else-if="appStore.jobs.good.length === 0" class="empty-state">
      <div class="empty-state-icon">🎉</div><div class="empty-state-text">还没有人分享好工作</div>
